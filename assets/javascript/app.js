var q1 = {
    ...
    explanation: '<div id="legend">In his spare time, King rested, wrote and preached at Ebenezer Baptist, a recently restored gem at 407 Auburn Avenue in Atlanta.</div>'
};
var q2 = {
    ...
    explanation: '<div id="legend"> Busloads of Freedom Riders went from town to town, testing local compliance with federal orders to desegregate interstate bus terminals.</div>'
};
var q3 = {
    ...
    explanation: '<div id="legend">Parks was arrested Dec. 1, 1955, after refusing to surrender her seat to a white passenger.</div>'
};
var q4 = {
    ...
    explanation: '<div id="legend">Huey P. Newton and Bobby Seale got permission to adapt the emblem for their Oakland-based Black Panther Party.</div>'
};
var q5 = {
    ...
    explanation: '<div id="legend">The book explores her early years, spent in St. Louis and Stamps, Ark.</div>'
};
var q6 = {
    ...
    explanation: '<div id="legend">He changed his name after joining the Nation of Islam in 1964.</div>'
};
var q7 = {
    ...
    explanation: '<div id="legend">The store was in downtown Greensboro, N.C.</div>'
};
var q8 = {
...
var q9 = {
    ...
    explanation: '<div id="legend">Thousands of Pullman porters created the first labor union for African Americans and exemplified the possibility of upward mobility for blacks.</div>'
};
var q10 = {
    ...
    explanation: '<div id="legend">Carmichael replaced John Lewis and began advocating black power.</div>'
};
